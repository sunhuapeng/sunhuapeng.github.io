...
exports.createVehicle = exports.vehicleUpdate = void 0;
 ...
 */
function createVehicle(pos, quat, physicsWorld) {
    var actions = {};
    ...
    function addWheel(isFront, pos, radius, width, index, name) {
        ...
        var mesh = createWheelMesh(radius, width, index);
        mesh.name = name;
        group.add(mesh);
    ...
    exports.vehicleUpdate = function () {
    ...
    return {
        vehicleUpdate: exports.vehicleUpdate, group: group, chassisMesh: chassisMesh
    };
}
